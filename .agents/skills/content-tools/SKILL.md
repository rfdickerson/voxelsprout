...
changes on screen. See AGENTS.md's Asset mods section for the cache-key consequence.
...
before believing any number it prints.** See the optimized-build section of `AGENTS.md` for the
presets.
