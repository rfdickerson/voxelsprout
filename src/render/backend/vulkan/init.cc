...
bool RendererBackend::createSwapchain() {
    ...
    uint32_t imageCount = std::max(support.capabilities.minImageCount, kMaxFramesInFlight);
...
void RendererBackend::shutdown() {
    ...
    m_debugGpuGiSurfaceTemporalTimeMs = 0.0f;
    m_debugGpuGiSurfaceSpatialTimeMs = 0.0f;
    m_debugGpuGiSurfaceResolveTimeMs = 0.0f;
    ...
    m_voxelGiSurfaceLastLoggedRequestedRt = false;
    m_voxelGiSurfaceLastLoggedRequestedRestir = false;
    m_voxelGiSurfaceLastLoggedRtReady = false;
    m_voxelGiSurfaceLastLoggedRestirReady = false;
    m_voxelGiSurfaceLastLoggedValid = false;
    ...
    m_debugCpuFrameTotalMsHistory.clear();
    m_debugCpuFrameWorkMsHistory.clear();
    m_debugCpuFrameEwmaMsHistory.clear();
    m_debugCpuFrameWorkMs = 0.0f;
    m_debugCpuFrameEwmaMs = 0.0f;
    m_debugCpuFrameEwmaInitialized = false;
    m_debugGpuFrameTimingMsHistory.clear();
    m_debugPresentedFrameTimingMsHistory.clear();
