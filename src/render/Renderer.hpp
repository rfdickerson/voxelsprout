...
private:
    ...
    void destroyNormalDepthTargets();
    ...
    std::vector<VkImage> m_normalDepthDepthImages;
    std::vector<VkDeviceMemory> m_normalDepthDepthImageMemories;
    std::vector<VkImageView> m_normalDepthDepthImageViews;
    VkSampler m_normalDepthSampler = VK_NULL_HANDLE;
    std::vector<VkImage> m_ssaoImages;
    std::vector<VkDeviceMemory> m_ssaoImageMemories;
    std::vector<VkImageView> m_ssaoImageViews;
    std::vector<bool> m_ssaoImageInitialized;
    ...
    VkPipeline m_normalDepthVoxelPipeline = VK_NULL_HANDLE;
    VkPipeline m_normalDepthPipePipeline = VK_NULL_HANDLE;
