...
bool App::init() {
    ...
    m_renderParams.scene.volume.densityScale = 1.75f;
    m_renderParams.scene.volume.anisotropyG = 0.82f;
    m_renderParams.scene.volume.albedo = 0.97f;
    m_renderParams.scene.volume.macroScale = 1.35f;
    m_renderParams.scene.volume.detailScale = 0.95f;
    m_renderParams.scene.volume.coverage = 0.72f;
    m_renderParams.scene.volume.weatherScale = 0.12f;
    m_renderParams.scene.volume.cloudBase = 2.5f;
    m_renderParams.scene.volume.cloudTop = 7.5f;
    m_renderParams.scene.volume.erosionStrength = 0.25f;
...
void App::buildUi() {
    ...
    ImGui::SliderFloat("Macro scale", &m_renderParams.scene.volume.macroScale, 0.08f, 2.40f, "%.2f");
    ...
    ImGui::SliderFloat("Weather scale", &m_renderParams.scene.volume.weatherScale, 0.01f, 0.20f, "%.2f");
